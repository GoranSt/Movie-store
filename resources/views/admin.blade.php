            ...
            {{--<div class="col-md-10">--}}
                {{--@foreach($latest as $p)--}}
                    {{--<div class="col-md-3" style="padding: 30px;">--}}
                        ...
                        {{--</a>--}}
                        {{--<div class="form-group"> <div class="label label-info">  Price:</div><b>&nbsp;&nbsp;&nbsp; ${{ $p->price}} </b> </div>--}}
                ...
                {{--<div class="panel panel-default">--}}
                    ...
                    @foreach($all as $p)
                        <div class="col-md-4">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body" style="margin-left: 50px;">
                                    <div> <img src="{{ $p->img }}" width="150px;" height="210px;"></div>
                        ...
                        <div style="padding-top: 10px;">
                          ...
                          <a class="btn btn-success" href="http://localhost:8888/movies/{{$p->id}}/edit">&nbsp;&nbsp;Edit &nbsp;</a>
                                    <a class="btn btn-danger" href="http://localhost:8888/movies/{{$p->id}}/delete">Delete</a>
